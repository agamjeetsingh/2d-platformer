...
#include "../../../include/physics/2d/SpacialHashMap.h"
#include "../../../include/physics/2d/CollisionsHandler.h"

SpacialHashMap::SpacialHashMap(CollisionsHandler* collisions_handler, size_t size) : num_buckets(size), collisions_handler(collisions_handler) {
...
std::vector<size_t> SpacialHashMap::getHashes(const CollidableObject *ptr) const {
